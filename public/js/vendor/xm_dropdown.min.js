...
function XM_Dropdown(t) {
  var c,
    ...
    e = function () {
      if (g.controlToggle) {
        var t = [];
        void 0 !== g.containerElement
          ? t.push(g.containerElement)
          : (t = document.querySelectorAll(g.container));
        var n = !0,
          e = !1,
          r = void 0;
        try {
        ...
        void 0 !== g.triggerElement
          ? g.triggerElement instanceof Array
            ? (c = g.triggerElement)
            : c.push(g.triggerElement)
          : (c = document.querySelectorAll(g.trigger));
        var f = !0,
          s = !1,
          u = void 0;
        try {
          for (
            ...
            m =
              void 0 !== g.containerElement
                ? g.containerElement
                : d.parentElement.querySelector(g.container);
            var p = {};
            (p.parent = m.parentElement),
              (p.trigger = d),
              (p.container = m),
              b.push(p);
          }
    ...
    a = function (t) {
      for (var n in ((t.parent.style.position = g.absolute
        ? "absolute"
        : "relative"),
      E(t.container, { position: "absolute", zIndex: g.animation.zIndex }),
      g.offset))
  ...
  return (
    (function t(n, e) {
      ...
      for (var o in e)
        "object" !== _typeof(e[o]) ||
        e[o] instanceof Date ||
        e[o] instanceof HTMLElement
          ? e[o] instanceof Date
            ? (n[o] = new Date(e[o].getTime()))
            : (n[o] = e[o])
          : ((r = e[o] instanceof Array ? [] : {}),
            void 0 === n[o] && (n[o] = r),
            t(n[o], e[o]));
    })(g, t),
    e(),
